    ...
    if value == 'DY':
        data = [
            go.Scatter(
                ...
                x=np.linspace(0,24,86400),#df[df['nodeID'] == i]['hour'][-24:],
                y=df[df['nodeID'] == i]['moisture'][-86400:],
                mode = 'lines',
                opacity=0.7,
                marker={
                    'size': 15,
        ...
        data = [
            go.Scatter(
                x=np.linspace(0,7,604800),#df[df['nodeID'] == i]['sec'][-60:],
                y=df[df['nodeID'] == i]['moisture'][-604800:],
                mode = 'lines',
                opacity=0.7,
                marker={
                    'size': 5,
        ...
        data = [
            go.Scatter(
                x=np.linspace(0,60,3600),#df[df['nodeID'] == i]['min'][-60:],
                y=df[df['nodeID'] == i]['moisture'][-3600:],
                mode = 'lines+markers',
                opacity=0.7,
                marker={
                    'size': 1,
