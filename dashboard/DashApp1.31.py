        ...
        html.Div(
            [
                    ...
                    dcc.RadioItems(
                            id = 'TimeFrame',
                            options=[
                                {'label': '3 Seconds', 'value': 'DY'},
                                {'label': '10 Seconds', 'value': 'WK'},
        ...
        html.Div(
            [
                ...
                figure={
                    'data': [
                        go.Scatter(
                            x=df[df['nodeIDs'] == i]['sec'][-3:],
                            y=df[df['nodeIDs'] == i]['moisture'][-3:],
                            mode = 'lines+markers',
                            opacity=0.7,
                            marker={
                                'size': 15,
...
def update_figure(value,n_intervals):
    ...
    if value == 'DY':
        ...
        data = [
            go.Scatter(
                x=df[df['nodeIDs'] == i]['sec'][-10:],
                y=df[df['nodeIDs'] == i]['moisture'][-10:],
                mode = 'lines+markers',
                opacity=0.7,
                marker={
                    'size': 15,
